...
def updatation_and_button_visibility(country_clickData,p1,p2,temp_list):
    ...
    if country_clickData is None or "country_button"==ctx.triggered_id:
        ...
        if selected_name in df['country'].unique():
            ...
            figure =cities(selected_name)
        else:
            # Handle other cases or set figure to an empty dictionary if needed
            figure = {}
    print(temp_list)
